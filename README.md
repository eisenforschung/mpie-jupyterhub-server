 ...
 **<a href="https://jupyter.org/" target="_top">Jupyter notebooks/lab</a>** are user friendly tools to perform data analysis, visualization, simulation, etc. You can basically access a coding environment from your browser. Therefore, via our server you will be able to analyse you experimental/simulation data via opensource python packages on your browser. Of course the computational resource would be granted via the server.
